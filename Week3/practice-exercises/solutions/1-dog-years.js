 ...
 *   Return a string: "Your doggie is [CALCULATED_VALUE] years old in human years!"
 *   Call the function three times with different sets of values.
 * 
 * Expected output:
 *   calculateDogAge(1); // Returns "Your doggie is 7 years old in human years!"
 *   calculateDogAge(2); // Returns "Your doggie is 14 years old in human years!"
 *   calculateDogAge(3); // Returns "Your doggie is 21 years old in human years!"
 */
